...
def main():
    ...
    while True:
        ...
        if short_code == 'ex':
            ...
            user_name = input('Enter yor first name - ').strip()
            ...
            user_exists == user_name:
                ...
                while True:
                     ...
                     if short_code == 'ex':
                             ...
                             print(' ')
                             print(f'Credintial Created: Site Name: {site_name} - Account Name: {account_name} - Password: {password}')
                             print(' ')
                     elif short_code == 'dc':
                             print(' ')
                             if display_credentials(user_name):
                                 ...
                                 print(' ')
                                 for credetial in display_credentials(user_name):
